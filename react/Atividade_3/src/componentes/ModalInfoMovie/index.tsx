      ...
      <Modal.Body>
        <Row>
          <Col xs = "auto">
            ...
            />
            <p>{props.movieDetails?.release_date}<FontAwesomeIcon className="pt-2 px-2" icon={faCircle} size = "2xs"/>
            ...
            <Badge bg="warning" text="dark">
              <Alert.Link target = "_blank" href={`https://www.imdb.com/title/${props.movieDetails?.imdb_id}`}><span className="fw-bold" >IMDb</span> | {props.movieDetails?.imdb_id}</Alert.Link>
            </Badge>
          </Col>
          <Col >
